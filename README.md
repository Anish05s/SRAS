...
Request Classification — Auto-detects emergency type, severity (1-10), and urgency keywords from free text
Situation Report (SITREP) — Generates professional operational reports from live data
Zone Demand Forecast — Predicts demand for next 4 hours with risk level and recommendations
---
📁 Project Structure
```
emergency/
